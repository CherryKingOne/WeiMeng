...
class VolcengineModelCatalogProvider(OpenAICompatibleModelCatalogProvider):
    MODELS_ENDPOINT = f"{VolcengineLLMAdapter.DEFAULT_BASE_URL}/models"
    DEFAULT_MODEL = VolcengineLLMAdapter.DEFAULT_MODEL
    FALLBACK_MODELS = VolcengineLLMAdapter.SUPPORTED_MODELS
