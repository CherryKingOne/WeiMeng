...
export default function Text2VideoPage() {
  ...
  const text = {
    ...
    mode: isEn ? 'Text to Video' : '文生视频',
    promptPlaceholder: isEn
      ? 'Describe scene, motion, and camera language'
      : '描述你想要生成的视频内容',
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
              <textarea
                ...
                className="w-full h-32 bg-transparent border-none resize-none text-sm text-gray-700 placeholder-gray-400 focus:outline-none"
              />
            </div>
