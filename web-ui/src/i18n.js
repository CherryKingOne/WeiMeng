...
const messages = {
  en: {
    ...
    workspace: {
      ...
      confirm_delete: 'Delete Script Library',
      delete_warning: 'Are you sure you want to delete',
      delete_warning_suffix: '? This action cannot be undone.',
      ...
      api_extensions: 'MCP & API',
      api_extensions_desc: 'Manage MCP servers and API keys',
      general: 'General',
    ...
    studio: {
      ...
      novelAnalysis: {
        ...
        selectChapter: 'Select a chapter to view analysis',
        chapterNumber: 'Chapter {n}',
        extractedCharacters: 'Extracted Characters',
        extractedScenes: 'Extracted Scenes',
        extractedPlots: 'Extracted Plots',
        extractedDialogues: 'Extracted Dialogues',
        characterName: 'Name',
        characterRole: 'Role',
  ...
  zh: {
    ...
    workspace: {
      ...
      share_link: '分享链接：',
      confirm_delete: '删除剧本库',
      delete_warning: '确定要删除',
      delete_warning_suffix: '吗？此操作无法撤销。',
      delete_failed: '删除失败',
      ...
      api_extensions: 'MCP 与 API',
      api_extensions_desc: '管理 MCP 服务器和 API 密钥',
      general: '常规',
    ...
    studio: {
      ...
      novelAnalysis: {
        ...
        analyzing: '分析中...',
        noChapters: '暂无章节',
        selectChapter: '选择章节查看分析结果',
        chapterNumber: '第 {n} 章',
        extractedCharacters: '提取的角色',
        extractedScenes: '提取的场景',
        extractedPlots: '提取的情节',
        extractedDialogues: '提取的对话',
        characterName: '姓名',
        characterRole: '角色',
        characterDesc: '描述',
        sceneName: '场景',
