...
library.add(
  ...
  faGithub,
  faScaleBalanced, faBullseye, faCube, faArrowUpRightFromSquare, faCircleQuestion, faBookOpen, faCamera, faFileImport, faCircleCheck, faCopy
)
