...
library.add(
  ...
  faGithub,
  faScaleBalanced, faBullseye, faCube, faArrowUpRightFromSquare, faCircleQuestion, faBookOpen, faCamera, faFileImport, faCircleCheck, faCopy, faSpinner,
  faShareNodes, faHeart, faComment, faShare, faFilter, faEnvelopeOpen, faBan, faShieldHalved, faMessage, faInbox, faCloudArrowUp,
  faSyncAlt, faExpand, faTimes, faCircleNotch, faRotate, faFire
)
